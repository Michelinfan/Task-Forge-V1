...
function save(){localStorage.setItem(KEY,JSON.stringify(data)); if(window.taskforge) window.taskforge.syncTasks(data.tasks);}
...
render();
if(window.taskforge) window.taskforge.syncTasks(data.tasks);
