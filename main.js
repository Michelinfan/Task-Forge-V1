...
function getNotificationSoundPath() {
  const candidates = [
    path.join(process.resourcesPath, "app.asar.unpacked", "notification.wav"),
...
function playNotificationSound() {
  ...
  if (!soundPath) {
    console.error("No se encontró notification.wav");
    return;
  }
  ...
  try {
    // Do not detach this process: Windows must be allowed to finish playback.
